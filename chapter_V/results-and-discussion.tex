...
\hline
\textbf{Connector Topology} & \textbf{Closure Type} & \textbf{Baseline TSTT (hrs)} & \textbf{Braess Link Cand. Identified} & \textbf{Max Systemic Time Saved (mins)} \\ \hline
\endfirsthead
...
Under Uniform Disaggregation to evenly distribute zonal demand across all intersections, the simulation identified zero Braess link. Consequently, the maximum systemic travel time saved for both setups remained at 0 minutes, with a baseline TSTT of 3585.28 hours.
