...
Table~\ref{tab:5.1b} shows the top segments where bidirectional closures yielded the highest frequencies of roads closed that improved the system when removed. On the other hand, Table~\ref{tab:5.2b} 
