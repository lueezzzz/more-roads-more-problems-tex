...
When checking the data, there was no difference between the unidirectional and bidirectional closure for Ledesma St. The traffic distribution and the time saved were the same for both closure types. Figures 5.6 and 5.7 shows the spatial redistribution of traffic for the 2nd top Braess link found in the setup under Unidirectional Closure, which is Blumentritt 2.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=7cm]{figures/blumentritt 2 uni volume.png}
    \caption{Baseline vs. Closure Traffic Volume for Blumentritt 2} 
    \label{fig:blumentritt_volume}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=7cm]{figures/blumentritt 2 uni delta.png}
    \caption{Traffic Delta Map for Blumentritt 2 Closure} 
    \label{fig:blumentritt_delta}
\end{figure}
