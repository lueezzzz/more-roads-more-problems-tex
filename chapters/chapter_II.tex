...
In addressing traffic congestion, transportation modelling serves as a significant predictive and analytical tool for city planners. Alghamdi et al. (2022) argues that traffic modelling and simulation techniques offer a controlled, computational environment in predicting traffic behavior, evaluate infrastructural changes, and test transportation policies before being implemented in real-world settings. Moreover, this approach has been widely used in recent years for analyzing, simulating, and forecasting traffic behavior under varying degrees of complexity which ranges from congested urban areas to rural systems at micro and macro scales.

Furthermore, Suryani et al. (2021) demonstrated the practical applications of system dynamics modelling in simulating scenarios for improving urban mobility. Their study highlighted that simulating interventions, like public transport enhancements, can project significant reductions in traffic congestion.
