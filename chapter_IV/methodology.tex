...
\begin{figure}[H]
    ...
    \caption{Uniform Spatial Disaggregation with Unidirectional Closure.}
    \label{fig:setup_4}
\end{figure}


\subsubsection{Setup 5}
\label{sec:setup_5}
...
\begin{figure}[H]
    ...
    \caption{Unrestricted Connector Topology with Unidirectional Closure.}
    \label{fig:setup_5}
\end{figure}

\subsubsection{Setup 6}
\label{sec:setup_6}
...
\begin{figure}[H]
    ...
    \caption{Strategic Gates Connector Topology with Unidirectional Closure.}
    \label{fig:setup_6}
\end{figure}
