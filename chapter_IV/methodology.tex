...
As illustrated in Figure \ref{fig:research_activities}, the researchers conducted three stages of research activities. The first research activity is through data gathering, where the researchers collected information and parameters necessary for the study, specifically the road network data within the primary arterial roads within Iloilo City. Then, these findings serve as inputs for the computational modeling phase. Finally, the researchers analyzed the results of the computational modeling phase to identify and evaluate the presence of the Braess Paradox in the Iloilo City network.
